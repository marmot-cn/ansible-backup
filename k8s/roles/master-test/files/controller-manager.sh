...
MASTER_ADDRESS=${1:-"10.170.148.109"}
...
KUBE_CONTROLLER_MANAGER_ROOT_CA_FILE="--root-ca-file=/var/run/kubernetes/apiserver.crt"

# --service-account-private-key-file="": Filename containing a PEM-encoded private
# RSA key used to sign service account tokens.
KUBE_CONTROLLER_MANAGER_SERVICE_ACCOUNT_PRIVATE_KEY_FILE="--service-account-private-key-file=/var/run/kubernetes/apiserver.key"
EOF
