...
MASTER_ADDRESS=${1:-""}
ETCD_SERVERS=${2:-""}
SERVICE_CLUSTER_IP_RANGE=${3:-""}
ADMISSION_CONTROL=${4:-"ServiceAccount,NamespaceLifecycle,NamespaceExists,LimitRanger,SecurityContextDeny,ResourceQuota"}
...
KUBE_API_CLIENT_CA_FILE="--client-ca-file=/run/kubernetes/apiserver.crt"
...
KUBE_API_TLS_PRIVATE_KEY_FILE="--tls-private-key-file=/run/kubernetes/apiserver.key"
EOF
